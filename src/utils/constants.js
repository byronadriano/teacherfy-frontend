...
export const FORM_OPTIONS = {
  ...
  languages: [
    ...
    "Arabic", "French", "Korean", "Russian", "Hindi"
  ],
};

export const BASE_URL = "https://teacherfy-gma6hncme7cpghda.westus-01.azurewebsites.net";

export const GOOGLE_CLIENT_ID = "610970411179-kenrq7o9355fa90v2aj9pisroaurnvdm.apps.googleusercontent.com";
